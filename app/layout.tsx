...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: absoluteUrl("/images/emitronix-2026-hero-dubai.png"),
        width: 1672,
        height: 941,
  ...
  twitter: {
    ...
    title: site.title,
    description: site.description,
    images: [absoluteUrl("/images/emitronix-2026-hero-dubai.png")],
  },
  icons: {
    icon: "/favicon.svg",
  },
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    image: absoluteUrl("/images/emitronix-2026-hero-dubai.png"),
    description: site.description,
    email: site.email,
